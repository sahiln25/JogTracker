...
var savedParam = {'admin_login_email': 'admin@gmail.com', 'admin_login_password': '12345'};
    ...
    describe("Record Create Tests", function(done) {
        beforeEach(function(done) {
            chai.request(url)
                ...
                .set('x-access-token', user_token_1)
                .set('content-type', 'application/x-www-form-urlencoded')
                .send({user_id: user_id_1, date:"01/01/2017", time:"10", distance:"5"})
                .end(function(err, res) {
                    chai.expect(res).to.have.status(200);
                    done();
                });
        ...
        beforeEach(function(done) {
            chai.request(url)
                ...
                .set('x-access-token', user_token_2)
                .set('content-type', 'application/x-www-form-urlencoded')
                .send({user_id: user_id_2, date:"01/01/2017", time:"10", distance:"5"})
                .end(function(err, res) {
                    chai.expect(res).to.have.status(200);
                    done();
                });
        ...
        beforeEach(function(done) {
            chai.request(url)
                ...
                .set('x-access-token', user_token_3)
                .set('content-type', 'application/x-www-form-urlencoded')
                .send({user_id: user_id_3, date:"01/01/2017", time:"10", distance:"5"})
                .end(function(err, res) {
                    chai.expect(res).to.have.status(200);
                    done();
                });
        ...
        describe('Regular Create Test', function(done) {
            ...
            it('Record Create - Valid User - Invalid Record - Invalid date', function(done) {
                chai.request(url)
                    ...
                    .set('x-access-token', user_token_1)
                    .set('content-type', 'application/x-www-form-urlencoded')
                    .send({user_id: user_id_1, date:"01012012", time:"10", distance:"5"})
                    .end(function(err, res) {
                        chai.expect(res).to.have.status(400);
                        done();
                    });
            ...
            it('Record Create - Valid User - Invalid Record - negative time', function(done) {
                chai.request(url)
                    ...
                    .set('x-access-token', user_token_1)
                    .set('content-type', 'application/x-www-form-urlencoded')
                    .send({user_id: user_id_1, date:"01/01/2017", time:"-1", distance:"5"})
                    .end(function(err, res) {
                        chai.expect(res).to.have.status(400);
                        done();
                    });
            ...
            it('Record Create - Valid User - Invalid Record - time too large', function(done) {
                chai.request(url)
                    ...
                    .set('x-access-token', user_token_1)
                    .set('content-type', 'application/x-www-form-urlencoded')
                    .send({user_id: user_id_1, date:"01/01/2017", time:"999999999999999999999", distance:"5"})
                    .end(function(err, res) {
                        chai.expect(res).to.have.status(400);
                        done();
                    });
            ...
            it('Record Create - Valid User - Invalid Record - non-integer time', function(done) {
                chai.request(url)
                    ...
                    .set('x-access-token', user_token_1)
                    .set('content-type', 'application/x-www-form-urlencoded')
                    .send({user_id: user_id_1, date:"01/01/2017", time:"5.5", distance:"5"})
                    .end(function(err, res) {
                        chai.expect(res).to.have.status(400);
                        done();
                    });
            ...
            it('Record Create - Valid User - Invalid Record - negative distance', function(done) {
                chai.request(url)
                    ...
                    .set('x-access-token', user_token_1)
                    .set('content-type', 'application/x-www-form-urlencoded')
                    .send({user_id: user_id_1, date:"01/01/2017", time:"1", distance:"-1"})
                    .end(function(err, res) {
                        chai.expect(res).to.have.status(400);
                        done();
                    });
            ...
            it('Record Create - Valid User - Invalid Record - distance too large', function(done) {
                chai.request(url)
                    ...
                    .set('x-access-token', user_token_1)
                    .set('content-type', 'application/x-www-form-urlencoded')
                    .send({user_id: user_id_1, date:"01/01/2017", time:"5", distance:"999999999999999999999"})
                    .end(function(err, res) {
                        chai.expect(res).to.have.status(400);
                        done();
                    });
            ...
            it('Record Create - Valid User - Invalid Record - non-integer distance', function(done) {
                chai.request(url)
                    ...
                    .set('x-access-token', user_token_1)
                    .set('content-type', 'application/x-www-form-urlencoded')
                    .send({user_id: user_id_1, date:"01/01/2017", time:"5", distance:"5.5"})
                    .end(function(err, res) {
                        chai.expect(res).to.have.status(400);
                        done();
                    });
